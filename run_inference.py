...
if __name__ == "__main__":
    MODEL_PATH_FOR_MODULE_TEST = "/ytech_m2v8_hdd/workspace/kling_mm/Models/wall-oss-flow"
    train_config_path = "/ytech_m2v8_hdd/workspace/kling_mm/daiyifan/wall-x/workspace/lerobot_example/config_qact_from_vlm.yml"
    ...
    try:
        ...
        # Local Image
        img = Image.open(
            "/ytech_m2v8_hdd/workspace/kling_mm/daiyifan/wall-x/assets/cot_example_frame.png"
        ).convert("RGB")
        # Internet Image
        # import requests
